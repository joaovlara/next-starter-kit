      ...
      <section className="px-6 py-12">
        <article className="container-1 flex flex-col gap-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            >
              <h2 className="text-primary-3">{aboutHeader.section1Title}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            >
              <h2 className="text-secondary">{aboutHeader.section2Title}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <motion.div
              ...
              className="space-y-3 bg-texture-pattern"
            >
              <h2 className="text-primary-3">{aboutHeader.section3Title}</h2>
